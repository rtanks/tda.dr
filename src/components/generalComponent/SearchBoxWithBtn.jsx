...
export default function SearchBoxWithBtn({children}) {
    const [len, setLen] = useState(0);
    const {menu, icon} = children;
    return (
        <div className="w-full md:w-[30%] flex gap-2 md:gap-4">
            <div className="h-13 bg-gray-200 w-13 rounded-xl flex items-center justify-center text-[#676767] md:hidden">
                {menu}
            </div>
