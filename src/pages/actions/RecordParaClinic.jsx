...
export default function RecordParaClinic() {
    const navigate = useNavigate();

    return (
        <div className="w-full h-max vazir-medium">
            <TestHeader title={"ثبت پاراکلینیک"} onClick={() => navigate("/account/need-for-action")}/>
            <div className="w-[90%] mx-auto flex flex-col gap-2 pb-2">
                ...
                <RequestAndExplain typeRequest={"پاراکلینیک"} titleRequest={"cbc - bun - cr - na - k"}/>
            </div>
